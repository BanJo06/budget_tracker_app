      ...
      <View className="m-5 rounded-xl w-[90%] bg-white dark:bg-bgPrimary-dark shadow-lg overflow-hidden">
        {type === "income" ? (
          ...
          <View className="bg-white dark:bg-bgPrimary-dark p-5 pt-8 rounded-t-xl border-b border-gray-300">
            <View className="flex-row justify-between items-center w-full mb-4">
              <Pressable
                className="w-10 h-10 rounded-full border border-black dark:border-textPrimary-dark justify-center items-center"
                onPress={() => setSelectedTransaction(null)}
              >
                <Text className="text-black dark:text-textPrimary-dark text-2xl">
                  ×
                </Text>
              </Pressable>
            ...
            <Text className="text-black dark:text-textPrimary-dark text-lg font-semibold mb-1">
              EXPENSE
            </Text>
          ...
          {type === "transfer" ? (
            <>
              <View className="flex-row justify-between items-center w-full py-3">
                ...
                <View className="flex-row items-center border border-purple-400 rounded-full px-4 py-1.5">
                  ...
                  <Text className="ml-2 text-base text-textPrimary-light dark:text-textPrimary-dark">
                    {account_name}
                  </Text>
                </View>
              </View>
            ...
            <>
              ...
              <View className="flex-row justify-between items-center w-full py-3">
                ...
                <View className="flex-row items-center border border-purple-400 rounded-full px-4 py-1.5">
                  <SVG_ICONS.Category size={20} color="#8B2BE2" />
                  <Text className="ml-2 text-base text-textPrimary-light dark:text-textPrimary-dark">
                    {category_name}
                  </Text>
                </View>
